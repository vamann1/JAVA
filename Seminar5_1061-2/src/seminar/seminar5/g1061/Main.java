...
//            }).toList();
            List<MijlocFix> cerinta4 = lista.stream().
                    sorted((o1, o2) -> Double.compare(o1.calculUzura(), o2.calculUzura())).toList();
...
//                    });
            Map<Categorie, List<Long>> cerinta11 = lista.stream()
                    .collect(
                            ...
                            (map1, map2) -> map2.forEach(((categorie, nrinv) -> map1.merge( categorie, nrinv, (nrinv1, nrinv2)-> {
                                    nrinv1.addAll(nrinv2);
                                    return nrinv1;
                         })))
                    );
